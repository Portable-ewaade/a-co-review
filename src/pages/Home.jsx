            ...
            <div className="container pt-2 text-start justify-content-center">
              <div className="row">
                <div classname="col-lg-6 col-md-8">
                  ...
                  <p className='grey fs-11 w-50 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum earum sed eaque laudantium vitae,ut nam laboriosam distinctio ipsa saepe possimus provident esse nesciunt facere </p>
          ...
          <div className="ui-wrapper-large">
            <div className="container">
              <div className="text-center">
                ...
                <p className='fs-11'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum earum sed eaque laudantium vitae</p>
                ...
                <div className="row works">
                  <div className="col-md my-3">
                    ...
                    <img src="../../../../assets/images/icon.png" alt="" className="mb-3" />
                     ...
                     <p className='grey fs-11'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum earum sed eaque laudantium vitae,.</p>
                    </div>
                  </div>
                  <div className="col-md my-3">
                    <div className=" pt-2">
              ...
              <div className="row">
                <div className="col-lg-6 text-center mx-auto">
                  <div>
                    ...
                    <p className='grey fs-13'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum earum sed eaque laudantium vitae,</p>
                    <button className="large-btn btn-lg mt-2 fs-12 font-weight-light" type="button">Get in Touch <i class="bi bi-arrow-right"></i></button>
                  </div>
                  <div>
